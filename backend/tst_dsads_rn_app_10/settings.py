"""
Django settings for tst_dsads_rn_app_10 project.
...
ROOT_URLCONF = 'tst_dsads_rn_app_10.urls'
...
WSGI_APPLICATION = 'tst_dsads_rn_app_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_dsads_rn_app_10 API",
    "DESCRIPTION": "API documentation for tst_dsads_rn_app_10 App",
    "VERSION": "v1",
}
